...
--
-- Host: localhost
-- Tempo de geração: 15-Abr-2021 às 15:42
...
(1, '00223556998', 'maria@gmail.com', 'Maria Silva', 1);
...
(1, 'bairro das graças', '4569985', 'casa sem chão', 'Rua das dores', '75', 2, 1),
(2, 'bairro', 'cep', 'complemento', 'logradouro', 'numero', 1, 1);
...
INSERT INTO `item_pedido` (`disconto`, `preco`, `quantidade`, `pedido_id`, `produto_id`) VALUES
(0, 2000, 2, 1, 1),
(0, 80, 1, 1, 3),
(0, 800, 1, 2, 2);
...
(1, '2017-09-30 10:32:00', 1, 2),
(2, '2017-10-10 10:31:00', 1, 1);
